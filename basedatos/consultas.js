...
// funcion que devuelve la informacion de un producto dado su código
    ...
    carrito.forEach((elemento, posicion) => {
        ...
        li.innerHTML = `
                <div class="d-flex justify-content-between align-items-center p-2 border-bottom border-dark">
                    ...
                    <a class="btn bg-warning text-decoration-none text-dark bg-transparent" href="#" onclick="eliminarProductoServicio('${posicion}')" >
